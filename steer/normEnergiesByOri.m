...
% Compute normalizers - energy per level and orientation
% But only for the orientation corresponding to whichOri
for level = 1:numLevels
  for orientation = whichOri %1:numOrientations
    ...
    normalizers(normIndices)=normalizers(normIndices)+energies(pyrIndices);%adding the energy for this level/sf and orientation
  end
end
